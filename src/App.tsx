      ...
      <div className="min-h-screen bg-space-navy flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            <span className="text-white text-xl">Loading your space adventure...</span>
            <motion.div
              className="text-4xl"
              animate={{ rotate: [0, -360] }}
              transition={{ duration: 3, repeat: Infinity, ease: "linear" }}
    ...
    <div className="min-h-screen bg-space-navy relative overflow-x-hidden">
      ...
      <motion.div
        ...
        onClick={() => {
          ...
          alert("🌟 Fun Fact: The Sun's core is 27 million degrees Fahrenheit! That's 150 times hotter than boiling water! ☀️");
        }}
        animate={{
          opacity: [0.7, 1, 0.7],
          rotate: [0, 5, -5, 0],
      ...
      <motion.div
        ...
        onClick={() => {
          // Another easter egg
          alert("🌌 Did you know? Aurora lights can be seen from space as a glowing ring around Earth's poles! 🛰️");
        }}
        animate={{
          opacity: [0.5, 1, 0.5],
          scale: [1, 1.1, 1],
