  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      description: "Leads the project and handles data integration, storytelling, video production, and scenario development. Passionate about making space science accessible to kids!",
      avatar: "👨‍🚀",
      color: "bg-space-sun",
    },
    {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-white max-w-4xl mx-auto leading-relaxed">
            We're a team of space enthusiasts who love sharing the wonders of space weather 
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-white leading-relaxed">
                We believe that understanding space weather helps kids appreciate both the 
                beauty and power of our cosmic environment, inspiring the next generation 
            ...
            <div className="relative">
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div className="flex-1 pl-8">
                    <p className="text-white/80 text-sm">
                      "Tell Us a Story: Space Weather Through the Eyes of Earthlings"
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="flex-1 pl-8">
                    <p className="text-white/80 text-sm">
                      Complete educational platform with stories, games, and AI chat!
                    </p>
                  </div>
                </motion.div>
              </div>
