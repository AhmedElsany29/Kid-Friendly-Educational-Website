      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-white/60 text-xs max-w-2xl mx-auto leading-relaxed">
            This educational platform uses real space weather data and scientific concepts 
            to teach kids about solar activity and its effects on Earth. All content is 
            designed to be fun, safe, and scientifically accurate! 🌟🔬
          </p>
        </motion.div>
      </div>
    </motion.footer>
